...
var ASM_CONSTS = {
  3908692: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3908747: function($0) {performance.now = function() { return $0; };},  
 3908795: function($0) {performance.now = function() { return $0; };},  
 3908843: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3908898: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3908959: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3909023: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _sendToNative(gameState) {
      //window.postMessage(UTF8ToString(gameState), '*');
      window.parent.postMessage(UTF8ToString(gameState), '*');
      //window.parent.alert("Parent Alert");
      // send a message to react native webview if on mobile
  
      //window?.ReactNativeWebView?.postMessage(UTF8ToString(gameState));
      //window?.ReactNativeWebView?.alert("React View Alert");
  ...
  function _setupEventListenerFromNative() {
  
      window.addEventListener("message", (event) => {
  
          SendMessage('Controller', 'ReceiveFromApp', event.data);
...
var asmLibraryArg = {
  ...
  "sendToNative": _sendToNative,
  "setTempRet0": _setTempRet0,
  "setupEventListenerFromNative": _setupEventListenerFromNative,
  "strftime": _strftime
};
var asm = createWasm();
/** @type {function(...*):?} */
